...
export const gitHash = process.env.ROFLCORD_HASH || execSync("git rev-parse --short HEAD", { encoding: "utf-8" }).trim();
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.ROFLCORD_REMOTE;
            if (!remote) {
...
export const commonOpts = {
    ...
    jsx: "transform",
    jsxFactory: "RoflcordCreateElement",
    jsxFragment: "RoflcordFragment"
};

...
export default definePlugin({
    ...
    patches: [
        {
            ...
            replacement: {
                ...
                // react.jsx(WrapperComponent, { RoflcordOriginal: AccountPanel, ...
                replace: "$self.PanelWrapper,{RoflcordOriginal:$1,"
            }
        },
        {
            find: ".PLAYER_DEVICES",
    ...
    PanelWrapper({ RoflcordOriginal, ...props }) {
        return (
            <>
                <ErrorBoundary
                    fallback={() => (

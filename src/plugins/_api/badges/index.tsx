...
const ContributorBadge: ProfileBadge = {
    description: "Roflcord Contributor",
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.roflcord.dev/badges.json", init)
        .then(r => r.json());
}
            ...
            onClick() {
                const modalKey = openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        closeModal(modalKey);
                        RoflcordNative.native.openExternal("https://github.com/sponsors/Vendicated");
                    }}>
                        <ModalRoot {...props}>
                            <ModalHeader>
                            ...
                            <ModalContent>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for Roflcord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of Roflcord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </ModalContent>
                            <ModalFooter>

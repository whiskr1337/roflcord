    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: "[$1].concat(Roflcord.Api.ServerList.renderAll(Roflcord.Api.ServerList.ServerListRenderPosition.Above))"
            }
        },
        {
            find: ".setGuildsTree(",
            replacement: {
                ...
                replace: "Roflcord.Api.ServerList.renderAll(Roflcord.Api.ServerList.ServerListRenderPosition.In).concat($&)"
            }
        }
    ]
});

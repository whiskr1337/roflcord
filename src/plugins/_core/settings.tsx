...
import { BackupAndRestoreTab, CloudTab, PatchHelperTab, PluginsTab, ThemesTab, UpdaterTab, RoflcordTab } from "@components/settings/tabs";
...
export default definePlugin({
    ...
    makeSettingsCategories(SectionTypes: SectionTypes) {
        return [
            ...
            {
                section: "RoflcordPlugins",
                label: "Plugins",
                element: PluginsTab,
                className: "vc-plugins"
            },
            {
                section: "RoflcordThemes",
                label: "Themes",
                element: ThemesTab,
                className: "vc-themes"
            },
            !IS_UPDATER_DISABLED && {
                section: "RoflcordUpdater",
                label: "Updater",
                element: UpdaterTab,
                className: "vc-updater"
            },
            {
                section: "RoflcordCloud",
                label: "Cloud",
                element: CloudTab,
                className: "vc-cloud"
            },
    ...
    options: {
        settingsLocation: {
            ...
            description: "Where to put the Roflcord settings section",
            options: [
    ...
    get electronVersion() {
        return RoflcordNative.native.getVersions().electron || window.legcord?.electron || null;
    },

    get chromiumVersion() {
        try {
            return RoflcordNative.native.getVersions().chrome
    ...
    getInfoRows() {
        ...
        const rows = [`Roflcord ${gitHash}${additionalInfo}`];

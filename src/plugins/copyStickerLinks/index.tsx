        ...
        <>
            <Menu.MenuGroup>
                ...
                <Menu.MenuItem
                    ...
                    label="Open Link"
                    action={() => RoflcordNative.native.openExternal(getUrl(sticker))}
                />
            </Menu.MenuGroup>
...
const expressionPickerPatch: NavContextMenuPatchCallback = (children, props: { target: HTMLElement; }) => {
    ...
    if (sticker) {
        children.push(buildMenuItem(sticker, Roflcord.Plugins.isPluginEnabled(ExpressionClonerPlugin.name)));
    }
};

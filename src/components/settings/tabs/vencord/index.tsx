...
import { gitRemote } from "@shared/roflcordUserAgent";
...
function RoflcordSettings() {
    ...
    return (
        <SettingsTab title="Roflcord Settings">
            {isDonor(user?.id)
                ? (
                    <SpecialCard
                        title="Donations"
                ...
                : (
                    <SpecialCard
                        ...
                        description="Please consider supporting the development of Roflcord by donating!"
            ...
            {isPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Roflcord you now have a cool new badge!"
                    ...
                    {!IS_WEB && (
                        <>
                            ...
                            <QuickAction
                                ...
                                action={() => RoflcordNative.settings.openFolder()}
                            />
                        </>
                    )}
                    <QuickAction
                        ...
                        action={() => RoflcordNative.native.openExternal("https://github.com/" + gitRemote)}
                    />
                </QuickActionCard>
            </Forms.FormSection>
            ...
            <Forms.FormSection className={Margins.top16} title="Settings" tag="h5">
                <Forms.FormText className={Margins.bottom20} style={{ color: "var(--text-muted)" }}>
                    ...
                    <a onClick={() => openPluginModal(Roflcord.Plugins.plugins.Settings)}>
...
export default wrapTab(RoflcordSettings, "Roflcord Settings");

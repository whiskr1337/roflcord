...
async function onFileUpload(e: SyntheticEvent<HTMLInputElement>) {
    ...
    const uploads = Array.from(files, file => {
        ...
        return new Promise<void>((resolve, reject) => {
            ...
            reader.onload = () => {
                RoflcordNative.themes.uploadTheme(name, reader.result as string)
                    .then(resolve)
                    .catch(reject);
            };
...
export function LocalThemesTab() {
    ...
    async function refreshLocalThemes() {
        const themes = await RoflcordNative.themes.getThemesList();
            ...
            <Forms.FormSection title="Local Themes">
                <QuickActionCard>
                    <>
                        {IS_WEB ?
                            (
                                ...
                                <QuickAction
                                    ...
                                    action={() => RoflcordNative.themes.openFolder()}
                                    Icon={FolderIcon}
                                />
                            )}
                        <QuickAction
                        ...
                        {Roflcord.Plugins.isPluginEnabled(ClientThemePlugin.name) && (
                            <QuickAction
                    ...
                    {userThemes?.map(theme => (
                        <ThemeCard
                            ...
                            onDelete={async () => {
                                ...
                                await RoflcordNative.themes.deleteTheme(theme.fileName);
                                refreshLocalThemes();
                            }}
                            theme={theme}
                        />

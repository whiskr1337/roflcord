...
function Updater() {
    ...
    return (
        <SettingsTab title="Roflcord Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>

            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Roflcord without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Show a notification when Roflcord automatically updates"

...
function ExcludedPluginsList({ search }: { search: string; }) {
    ...
    const ExcludedReasons: Record<"web" | "discordDesktop" | "vesktop" | "desktop" | "dev", string> = {
        ...
        dev: "Developer version of Roflcord"
    };
...
function PluginSettings() {
    ...
    const pluginFilter = (plugin: typeof Plugins[keyof typeof Plugins]) => {
        ...
        const enabled = Roflcord.Plugins.isPluginEnabled(plugin.name);
    ...
    const [newPlugins] = useAwaiter(() => DataStore.get("Roflcord_existingPlugins").then((cachedPlugins: Record<string, number> | undefined) => {
        ...
        DataStore.set("Roflcord_existingPlugins", existingTimestamps);
    ...
    for (const p of sortedPlugins) {
        ...
        if (isRequired) {
            const tooltipText = p.required || !depMap[p.name]
                ? "This plugin is required for Roflcord to function."

...
export function NotificationSection() {
    return (
        <Forms.FormSection className={Margins.top16} title="Roflcord Notifications" tag="h5">
            <Flex>
    ...
    return (
        <div style={{ padding: "1em 0" }}>
            ...
            <Forms.FormText className={Margins.bottom8}>
                ...
                <ul>
                    <li><strong>Roflcord Notifications</strong>: These are in-app notifications</li>
            ...
            <Select
                ...
                options={[
                    ...
                    { label: "Always use Roflcord notifications", value: "never" },

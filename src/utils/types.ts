...
export interface PluginDef {
    ...
    /**
     * Allows you to add custom actions to the Roflcord Toolbox.
...
export const enum StartAt {
    /** Right away, as soon as Roflcord initialised */
    Init = "Init",
...
> {
    /** Shorthand for `Roflcord.Settings.plugins.PluginName`, but with typings */
    store: SettingsStore<Def> & PrivateSettings;
    /** Shorthand for `Roflcord.PlainSettings.plugins.PluginName`, but with typings */

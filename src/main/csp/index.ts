...
export const CspPolicies: PolicyMap = {
    ...
    "cdn.discordapp.com": ImageAndCssSrc, // Discord CDN, used by Roflcord and some themes to load media
    "media.discordapp.net": ImageSrc, // Discord media CDN, possible alternative to Discord CDN

    // CDNs used for some things by Roflcord.
    ...
    // Function Specific
    "api.github.com": ConnectSrc, // used for updating Roflcord itself
    "ws.audioscrobbler.com": ConnectSrc, // Last.fm API
    "translate-pa.googleapis.com": ConnectSrc, // Google Translate API
    "*.roflcord.dev": ImageSrc, // VenCloud (api.roflcord.dev) and Badges (badges.roflcord.dev)
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our Roflcord loader script https://content-security-policy.com/strict-dynamic/
        ...
        for (const directive of ["style-src", "connect-src", "img-src", "font-src", "media-src", "worker-src"]) {
            pushDirective(directive, "blob:", "data:", "roflcord:");
        }

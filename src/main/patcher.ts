...
console.log("[Roflcord] Starting up...");
...
if (!IS_VANILLA) {
    ...
    class BrowserWindow extends electron.BrowserWindow {
        constructor(options: BrowserWindowConstructorOptions) {
            if (options?.webPreferences?.preload && options.title) {
                ...
                options.webPreferences.preload = join(__dirname, IS_DISCORD_DESKTOP ? "preload.js" : "roflcordDesktopPreload.js");
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Roflcord");
    ...
    console.log("[Roflcord] Running in vanilla mode. Not loading Roflcord");
}

console.log("[Roflcord] Loading original Discord app.asar");
